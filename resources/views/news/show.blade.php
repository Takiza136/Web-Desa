...
@section('title', $news->title . ' - Desa Pasir Baru')
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <nav class="flex text-sm text-gray-500 mb-4" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                <li class="inline-flex items-center">
                    <a href="{{ url('/') }}" class="inline-flex items-center hover:text-green-600">Beranda</a>
                </li>
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ url('/berita') }}" class="ml-1 hover:text-green-600 md:ml-2">Kabar Desa</a>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="flex items-center text-sm text-gray-500 gap-4">
            <span class="flex items-center gap-1">
                ...
                {{ $news->published_at ? $news->published_at->format('d F Y') : 'Baru' }}
            </span>
            <span class="flex items-center gap-1">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
        @if($news->image_url)
            <img src="{{ $news->image_url }}" alt="{{ $news->title }}" class="w-full h-auto max-h-[500px] object-cover">
        @endif
        ...
        <div class="bg-gray-50 px-8 py-6 border-t border-gray-100 mt-8">
            <h3 class="text-sm font-semibold text-gray-900 uppercase tracking-wide mb-4">Bagikan Berita Ini</h3>
